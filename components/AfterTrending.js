...
const data = [
  {
    id: 0,
    bg: "url(https://www.maxim.com/wp-content/uploads/2022/03/Kid-Rock-2005-Ford-GT-Promo-788x443.jpg)",
    text: "Rides",
  ...
  {
    id: 1,
    bg: "url(background:url(hbackground:url(https://www.maxim.com/wp-content/uploads/2022/03/Best-Activewear-Featured-336x176.jpg)",
    text: "Style",
    href: "https://www.maxim.com/food-drink/7-great-riesling-wines-to-try-now/",
    pg: "Kid Rock’s Classic Ford GT Can Be Yours",
  },

  {
    id: 2,
    bg: "url(https://www.maxim.com/wp-content/uploads/2022/01/Tampa-Bay-Buccaneers-Rob-Gronkowski-Tom-Brady-Promo-336x179.jpg)",
    text: "Style",
    href: "https://www.maxim.com/food-drink/7-great-riesling-wines-to-try-now/",
    pg: "Rob Gronkowski Says He Wants To ‘Scare’ Tom Brady Before Returning To Buccaneers in Viral Video",
  },
  {
    id: 3,
...
export default function AfterTrending() {
  return (
    <div
      style={{
        width: "89%",
